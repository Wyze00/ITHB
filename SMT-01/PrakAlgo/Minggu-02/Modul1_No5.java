...
public class Modul1_No5 {
    ...
    public static void main(String[] args) {
         ...
         * Tugas 05 {Program}
         *
         * Var teknikal, artistik, juri1, juri2, juri3, totalNilai {int}
         *
         */
        ...
        juri1 = (avgArtistik + avgTeknikal) / 2;

        
        System.out.println("Nilai per aspek : ");
        System.out.println("Nilai teknikal : " + avgTeknikal);
        System.out.println("Nilai artistik : " + avgArtistik);
        ...
        avgTeknikal = (double) teknikal / 2;
        avgArtistik = (double) artistik / 2;
        juri2 = (avgArtistik + avgTeknikal) / 2;
        ...
        avgTeknikal = (double) teknikal / 2;
        avgArtistik = (double) artistik / 2;
        juri3 = (avgArtistik + avgTeknikal) / 2;
        ...
        System.out.println("Nilai juri ke-1 : " + juri1);
        System.out.println("Nilai juri ke-2 : " + juri2);
        System.out.println("Nilai juri ke-3 : " + juri3);
        System.out.println();

        totalNilai = (juri1 + juri2 + juri3) / 3;

        System.out.println("Total Nilainya adalah : " + Math.round(totalNilai));
